<template>
  <v-main class="list">
    ...
    <v-card>
      ...
      <v-data-table
          ...
          <template v-slot:[`item.select`]="{ item }">
            <v-checkbox  multiple :key="item" @click.capture.stop="toggleSelect(item)" color="red darken-3" value="red darken-3"></v-checkbox>
          </template>
    ...
    <v-dialog v-model="dialog" persistent max-width="600px">
      <v-card>
        <v-card-title>
            <span class="headline" v-if="adding == true" >
              Form Todo - Add
            </span>
      ...
      todos: [
        {
          task: "Tidur",
          priority: "Penting",
          note: "Terlalu lama bisa menyebabkan gagal ginjal",
        },
        {
          task: "Gibah",
          priority: "Tidak penting",
          note: "Gak baik karena dosa",
        },
        {
          task: "Main",
          priority: "Biasa",
          note: "Main aja terus sampe subuh!",
        },
      ],
